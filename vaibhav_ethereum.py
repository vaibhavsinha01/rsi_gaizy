...
class DeltaExchangeRFGaizy:
    ...
    def get_active_positions(self):
        """Get active positions from Delta Exchange for ETHUSD (product_id: 3136)"""
        try:
            method = "GET"
            path = "/v2/positions"
            url = self.base_url + path
    ...
    def set_leverage_delta(self, value, product_id):
        ...
        Args:
            ...
            product_id (int or str): The Delta Exchange product ID (e.g., 27 for BTCUSD).
        """
        import time
        import json
        import requests
        ...
        try:
            ...
            if last_signal != 0 and self.get_active_positions():
                ...
                if sl_price is not None and tp_price is not None:
                    ...
                    self.set_leverage_delta(value=self.base_leverage,product_id="3136")
                    self.leverage_check()
